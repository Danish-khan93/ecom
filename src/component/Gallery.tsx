...
const Gallery = () => {
  return (
    <Box className="px-[20px] w-full flex justify-evenly items-center py-[20px]">
      <Box>
        <Image src={Pic1} alt="gallery" className="w-[590px]" />
      </Box>
      <Box className="flex flex-col gap-3">
        <Image src={Pic2} alt="gallery" className="w-[590px]" />
        <Image src={Pic3} alt="gallery" className="w-[590px]" />
      </Box>
      <Box className="flex flex-col gap-3">
        <Box>
          <Image src={Pic4} alt="gallery" className="w-[590px]" />
        </Box>
        <Box className="flex justify-between ">
          <Image src={Pic5} alt="gallery" className="w-[290px]"/>
          <Image src={Pic6} alt="gallery" className="w-[290px]"/>
        </Box>
      </Box>
    </Box>
  );
